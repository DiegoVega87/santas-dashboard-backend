...
public class WeatherController {
    ...
    private ReindeerAlignment generateReindeerAlignment(String weatherCondition) {
        ...
        alignment.setLead(lead.getId());
        alignment.setFront1(frontReindeers.get(0).getId());
        alignment.setFront2(frontReindeers.get(1).getId());
        alignment.setMiddle1(middleReindeers.get(0).getId());
        alignment.setMiddle2(middleReindeers.get(1).getId());
        alignment.setMiddle3(middleReindeers.get(2).getId());
        alignment.setBack1(backReindeers.get(0).getId());
        alignment.setBack2(backReindeers.get(1).getId());
        alignment.setBack3(backReindeers.get(2).getId());
